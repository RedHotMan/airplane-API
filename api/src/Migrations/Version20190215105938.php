 ...
 */
final class Version20190215105938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN airplane_user.roles IS \'(DC2Type:json_array)\'');
        ...
        $this->addSql('CREATE TABLE luggage (id INT NOT NULL, passenger_id INT NOT NULL, weight INT NOT NULL, height INT NOT NULL, PRIMARY KEY(id))');
